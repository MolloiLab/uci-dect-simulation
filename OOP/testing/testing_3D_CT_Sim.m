...
phantom = load('prebuilt_objects\Phantoms\sphere.mat');
...
FP = AstraForwardProjector3D(Geoms.VolumeGeometry, Geoms.ProjectionGeometry);
...
BP = AstraFilteredBackProjector3D(Geoms.ProjectionGeometry, Geoms.ReconGeometry);
% BP.useGPU = false;
