...
% accessbile through this interface, eg. Parker weighting for half-scans.
    ...
    properties
        % describes the projection geometry of the sinogram
        ProjectionGeometry
        % describes the geometry of the reconstruction volume
        VolumeGeometry
    ...
    methods
        function this = AstraFilteredBackProjector3D(varargin)
            ...
            narginchk(2,2);
            % Inputs must be a projection geometry and a reconstruction
            % volume geometry
            if nargin == 2
