...
proj_geom = astra_create_proj_geom('fanflat', 1.0, 384, linspace2(0,pi,180), 600, 472);
...
astra_id_sino = astra_mex_data2d('create','-sino',proj_geom,0);
astra_mex_data2d('store', astra_id_sino, 0);
astra_mex_data2d('store',astra_id_sino, sinogram);
% figure(1); imshow(P, []);
